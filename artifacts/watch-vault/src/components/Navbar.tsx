...
import { Moon, Sun, Film, Tv, LayoutGrid, Heart, BarChart3, Menu } from "lucide-react";
...
export function Navbar() {
  ...
  const navLinks = [
    { href: "/", label: "Home", icon: <Film className="w-4 h-4 mr-2" /> },
    { href: "/browse", label: "Browse", icon: <LayoutGrid className="w-4 h-4 mr-2" /> },
