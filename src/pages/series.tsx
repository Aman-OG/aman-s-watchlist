...
export default function Series() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-12">
        <h1 className="text-4xl font-black mb-4">Series Collection</h1>
        <p className="text-muted-foreground text-lg max-w-2xl">
          Explore all the TV series I've watched. Search, filter, and sort to find your next binge.
        </p>
      </div>
        ...
        {media.length === 0 ? (
          <div className="col-span-full py-20 text-center">
            <div className="text-muted-foreground mb-4">
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground">No series found</h3>
