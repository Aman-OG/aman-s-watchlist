...
import { useStats } from "@/hooks/useWatchlist";
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="bg-card/50 border-border/50 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
